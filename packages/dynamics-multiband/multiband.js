 ...
 * @param {object|object[]} [opts.bands] — compressor params per band ({threshold, ratio,
 *   knee, attack, release, makeup}) or one object shared by all bands; omit a band's
 *   params (or pass null) to leave that band uncompressed
